	...
	return (
		<>
			...
			<div
				...
				data-aos="fade-up"
				data-aos-duration="600">
				<div className="w-[50%] text-base  font-medium">Otomatisasi Tata Kelola Kepegawaian</div>
			...
			<div
				...
				<div className="flex justify-center items-center text-sm">09.45-10.45</div>
			</div>
			<div
